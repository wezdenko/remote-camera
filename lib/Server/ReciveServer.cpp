...
ReciveServer::ReciveServer(Saver saver, int IP_TYPE, int STREAM_TYPE)
    : dataSaver(saver), ipType(IP_TYPE), streamType(STREAM_TYPE){};
...
void ReciveServer::closeServer() { close(sock); }